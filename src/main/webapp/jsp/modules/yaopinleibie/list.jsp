...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">药品类别管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>药品类别管理</span></li>
								<li class="breadcrumb-item active"><span>药品类别列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">药品类别列表</h3>							
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									<label>
										药品类别
									</label>
									<input type="text" id="yaopinleibieSearch" class="form-control form-control-sm" placeholder="请输入药品类别" aria-controls="tableId">
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
			if($('#yaopinleibieSearch').val() != null && $('#yaopinleibieSearch').val() != ''){
				searchForm.yaopinleibie ="%" +  $('#yaopinleibieSearch').val() + "%";
			}
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("yaopinleibie/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"yaopinleibie");
