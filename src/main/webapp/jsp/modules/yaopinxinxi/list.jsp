...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<select name="yaopinleibie" id="yaopinleibieSelect" class="form-control form-control-sm" aria-controls="tableId">
									</select>
									<label>
										品牌
									</label>
									...
									<input type="text" id="gongnengzhuzhiSearch" class="form-control form-control-sm" placeholder="请输入功能主治" aria-controls="tableId">
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th>封面</th>
											<th onclick="sort('yaopinleibie')">药品类别<i id="yaopinleibieIcon" class="fa fa-sort"></i></th>
											...
											<th onclick="sort('shichangjiage')">市场价格<i id="shichangjiageIcon" class="fa fa-sort"></i></th>
											<th>操作</th>
										</tr>
									</thead>
									<tbody>
	...
	<script>
		...
		function search(){
			...
			var yaopinleibieIndex = document.getElementById("yaopinleibieSelect").selectedIndex;
			var yaopinleibieOptions = document.getElementById("yaopinleibieSelect").options;
			var yaopinleibieSelectedOption = yaopinleibieOptions[yaopinleibieIndex]
			if(yaopinleibieSelectedOption.text != null && yaopinleibieSelectedOption.text != ''){
				searchForm.yaopinleibie = yaopinleibieSelectedOption.text;
			}
			if($('#pinpaiSearch').val() != null && $('#pinpaiSearch').val() != ''){
				searchForm.pinpai ="%" +  $('#pinpaiSearch').val() + "%";
			}
			
			if($('#gongnengzhuzhiSearch').val() != null && $('#gongnengzhuzhiSearch').val() != ''){
				searchForm.gongnengzhuzhi ="%" +  $('#gongnengzhuzhiSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("yaopinxinxi/page","GET",{
				...
				yaopinleibie : searchForm.yaopinleibie,	
				pinpai : searchForm.pinpai,	
				gongnengzhuzhi : searchForm.gongnengzhuzhi,	
			},(res)=>{
				if(res.code == 0){
					clear();
		...
		function setDataRow(item,number){
			...
			var yaopinleibieCell  = document.createElement('td');

						  yaopinleibieCell.innerHTML = item.yaopinleibie; 

			row.appendChild(yaopinleibieCell);
			...
			var shichangjiageCell  = document.createElement('td');

						 shichangjiageCell.innerHTML = item.shichangjiage;

			row.appendChild(shichangjiageCell);
			var gongnengzhuzhiCell  = document.createElement('td');

			
			var buliangfanyingCell  = document.createElement('td');
